...
def parse_args():
    ...
    parser.add_argument(
        "--model_save_dir",
        type=str,
        default="/home/jun/Desktop/AVQA/New_model5_0507_professor/train_professor_all+data/checkpoints",
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="avst_vq_channel_mlp_clipclap_all_data",
    )
...
def main():
    ...
    print("\n--------------- CLIP/CLAP Full-Data VQ-Spatial AVST ---------------")
