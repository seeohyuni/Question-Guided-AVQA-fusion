...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="avst_vq_channel_mlp_clipclap_all_data_audio_sincos_pos_notrain",
    )
...
def build_model(args, answer_vocab, device, train_dataset):
    ...
    print(
        ...
        f"positional_encoding=audio_sinusoidal_notrain max_time_steps={args.max_time_steps}"
    )
    return model
...
def run_test(args, device):
    ...
    metrics = {
        ...
        "target_type": args.target_type,
        "positional_encoding": "audio_sinusoidal_notrain",
        "max_time_steps": args.max_time_steps,
        "positional_dropout": args.positional_dropout,
        "accuracy": test_acc,
        "correct": correct,
...
def main():
    ...
    print("\n--------------- CLIP/CLAP Full-Data VQ-Spatial AVST + Audio Sin/Cos Positional Encoding ---------------")
